...
def special(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'mage':
        return (f'{char_name} применил умение «Атака {45}»')
    if char_class == 'healer':
        return (f'{char_name} применил умение «Защита {40}»')
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    print('Введи одну из команд: attack — чтобы атаковать противника, defence'
          ' — чтобы pазблокировать атаку противника или special —'
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        ...
        approve_choice = input('Нажми (Y-подтвердить выбор, '
                               'другую кнопку-повторный выбор').lower()
    return char_class
